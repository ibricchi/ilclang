...
class FullReplayInliningCallBacks(InliningControllerCallBacks):
...
def setup_parser(subparser: _SubParsersAction[ArgumentParser]) -> ArgumentParser:
    parser_replay = subparser.add_parser("full-replay", help="replay inlining decisions")
...
def run_inlining(
    ...
    callbacks = FullReplayInliningCallBacks(
